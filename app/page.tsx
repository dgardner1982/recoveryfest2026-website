    ...
    <div className="w-full">
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-blue-50 via-cyan-50 to-green-50 transform hover:scale-102 transition-transform duration-300">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-12 text-blue-900 animate-fade-in" style={{textShadow: '6px 6px 0 rgba(0,0,0,1), 8px 8px 0 rgba(0,0,0,0.5)', WebkitTextStroke: '1px rgba(0,0,0,0.05)'}}>
            Experience the Joy
          </h2>
