      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-center gap-6">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Button asChild size="lg" className="bg-gradient-to-r from-cyan-300 to-blue-400 hover:from-cyan-400 hover:to-blue-500 text-black shadow-lg hover:shadow-xl transition-all">
              <Link href="/">Home</Link>
            </Button>
            <Button asChild size="lg" className="bg-gradient-to-r from-pink-300 to-purple-400 hover:from-pink-400 hover:to-purple-500 text-black shadow-lg hover:shadow-xl transition-all">
